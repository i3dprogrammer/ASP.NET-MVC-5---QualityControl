...
namespace QualityOrganizationWebsite.Controllers
{
    public class PublicationsController : Controller
    {
        ...
        public ActionResult Add()
        {
            ...
            viewModel.ResearchFieldsList = new SelectList(new List<string> { "test1", "test2", "test3" }, "test1");
            int i = 0;
            viewModel.ResearchYearsList = new SelectList(Enumerable.Repeat<int>(i, 20));
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,ResearchField,Authors,National,ResearchYear,PubType,Details,Identifier,Abstract")] Publication publication)
        {
            if (ModelState.IsValid)
            {
